    ...
    <div className="flex justify-center flex-none ml-6">
      <a
        ...
        <button
          ...
          <span className="flex items-center justify-center gap-2 rounded-lg group-hover:text-yellow-400 text-white text-base font-semibold tracking-wide whitespace-nowrap px-4 py-2">
            <Mail className="group-hover:fill-yellow-400 fill-white w-5 h-5 flex-shrink-0" />
