...
export const HomePage = () => {
  ...
  const schema = {
    ...
    "@type": "Person",
    "name": "Portfolio User",
    "url": "https://personal-portfolio.demo",
    "jobTitle": "Software Developer"
  };

  return (
    <main className="page-wrapper" style={{ backgroundColor: '#040100', minHeight: '100vh' }}>
      <Helmet>
        <title>Portfolio | Senior Developer</title>
        <meta name="description" content="Personal portfolio showcasing development projects and expertise." />
